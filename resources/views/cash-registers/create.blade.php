...
@section('content')
    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Abrir caja</h1>
    ...
    <div class="mt-6 max-w-lg rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
        <form action="{{ route('cash-registers.sessions.store') }}" method="POST">
            ...
            <div>
                <label for="cash_register_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Caja</label>
            ...
            <div class="mt-4">
                <label for="shift_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Turno</label>
            ...
            <div class="mt-4">
                <label for="opening_amount" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Monto de apertura (S/)</label>
