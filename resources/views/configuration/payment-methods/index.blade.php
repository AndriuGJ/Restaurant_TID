...
@section('content')
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Medios de pago</h1>
            <p class="mt-1 text-sm text-gray-600">Configura las formas de pago aceptadas en el restaurante.</p>
        </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="divide-y divide-gray-200">
                @forelse ($paymentMethods as $paymentMethod)
                    <tr>
                        <td class="px-6 py-4 text-sm font-medium text-gray-900">{{ $paymentMethod->name }}</td>
