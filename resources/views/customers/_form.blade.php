<div class="space-y-6">
    ...
    <div>
        <label for="reference_address" class="block text-sm font-medium text-gray-700">Dirección de referencia</label>
        <textarea id="reference_address" name="reference_address" rows="2"
            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-brand-500 focus:ring-brand-500">{{ old('reference_address', $customer->reference_address ?? '') }}</textarea>
    </div>
    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        <div>
            <label for="document_number" class="block text-sm font-medium text-gray-700">N.º de documento</label>
